...
public class AceGui extends Project {
	/**
	 * 
	 */
	...
	AceGui() {
		...
		/*
		 * btnMyCalendar_1.setIcon(new ImageIcon(AceGui.class
		...
		/*
		 * btnMyCalendar_2.setIcon(new ImageIcon(AceGui.class
		 * .getResource("/calendar-alt-1-20.png")));
		 */
		...
		/*
		 * button_1.setIcon(new ImageIcon(AceGui.class
